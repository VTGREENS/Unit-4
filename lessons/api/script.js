...
* DNS (domain name) serer resolves string address representation into IP address
*http:// & https:// -> domain
    * can have subdomains (ex: lms.upright.com)
...
/* 
    ...
    * Stateless, cacheable, layered system allowing for req/ res using:
        *CRUD through POST, GET, PUT & DELETE methods
        * HTTP requests are sent from the client:
           * headers
           * body (optional)
           * queries or querry parameters
           * status codes
...
/* 
    ...
    * We don't know how long request-response lifecycle will take
    ...
    2. Use .then resolver to catch fath's return and assign to a parameter
    3. The parameter is part of Response interface object
    4. Body of our response  in inaccessable. Part of ReadableStream
    5. Utilize Response interface .json() method to read the steam
    6. json() method returns a promise
    7. Resolve the promise with one more .then() resp;ver
...
/*
    ...
    ! Response object can actually be access via a member access operator
        - dot notation
 */
